...
context API helps solves the problem of passing props down from component to component.
...
redux because it requires a little more work but easier to predict sate. Great for larger applications.
